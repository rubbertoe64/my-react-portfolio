    ...
    return(
        <div className='footer'>
            <div className='footer-flex'>
                ...
                <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/LinkedIn_logo_initials.png/640px-LinkedIn_logo_initials.png' onClick={sendLinkedIn}  alt='linkdin logo' className='footer-linkdin'></img>
            </div>
        </div>
    )
...
function sendLinkedIn(){window.open("https://www.linkedin.com/in/roberto-gonzalez-91a652222/", "_blank")}
